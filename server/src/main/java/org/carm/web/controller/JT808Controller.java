...
public class JT808Controller {
    ...
    public Mono<R<T0001>> T8103(@RequestBody T8103 request) {
        return messageService.requestR(request.build(), T0001.class);
    }

    @Operation(summary = "8104 查询终端参数")
    @PostMapping("8104")
    public Mono<R<T0104>> T8104(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.查询终端参数), T0104.class);
    }

    @Operation(summary = "8106 查询指定终端参数")
    @PostMapping("8106")
    public Mono<R<T0104>> T8106(@RequestBody T8106 request) {
        return messageService.requestR(request, T0104.class);
    }
    ...
    public Mono<R<T0107>> T8107(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.查询终端属性), T0107.class);
    }

    @Operation(summary = "8201 位置信息查询")
    @PostMapping("8201")
    public Mono<R<T0201_0500>> T8201(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.位置信息查询), T0201_0500.class);
    }
    ...
    public Mono<R<T0001>> T8204(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.服务器向终端发起链路检测请求), T0001.class);
    }
    ...
    public Mono<R<T0201_0500>> T8500(@RequestBody T8500 request) {
        return messageService.requestR(request, T0201_0500.class);
    }
    ...
    public Mono<R<T0001>> T8601(@RequestBody T8601 request) {
        return messageService.requestR(request.setMessageId(JT808.删除圆形区域), T0001.class);
    }
    ...
    public Mono<R<T0001>> T8603(@RequestBody T8601 request) {
        return messageService.requestR(request.setMessageId(JT808.删除矩形区域), T0001.class);
    }
    ...
    public Mono<R<T0001>> T8605(@RequestBody T8601 request) {
        return messageService.requestR(request.setMessageId(JT808.删除多边形区域), T0001.class);
    }
    ...
    public Mono<R<T0001>> T8607(@RequestBody T8601 request) {
        return messageService.requestR(request.setMessageId(JT808.删除路线), T0001.class);
    }

    @Operation(summary = "8608 查询区域或线路数据")
    @PostMapping("8608")
    public Mono<R<T0608>> T8608(@RequestBody T8608 request) {
        return messageService.requestR(request, T0608.class);
    }

    @Operation(summary = "8700 行驶记录仪数据采集命令")
    @PostMapping("8700")
    public Mono<R<T0001>> T8700(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.行驶记录仪数据采集命令), T0001.class);
    }
    ...
    public Mono<R<T0702>> T8702(@RequestBody JTMessage request) {
        return messageService.requestR(request.setMessageId(JT808.上报驾驶员身份信息请求), T0702.class);
    }

    @Operation(summary = "8801 摄像头立即拍摄命令")
    @PostMapping("8801")
    public Mono<R<T0805>> T8801(@RequestBody T8801 request) {
        return messageService.requestR(request, T0805.class);
    }

    @Operation(summary = "8802 存储多媒体数据检索")
    @PostMapping("8802")
    public Mono<R<T0802>> T8802(@RequestBody T8802 request) {
        return messageService.requestR(request, T0802.class);
    }
    ...
    public Mono<R<T0A00_8A00>> T8A00(@RequestBody T0A00_8A00 request) {
        return messageService.requestR(request, T0A00_8A00.class);
    }
}